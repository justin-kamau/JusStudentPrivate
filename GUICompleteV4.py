...
class MathGame(Frame):
    ...
    def ParentsReports(self,WhichFrame):
        ...
        lblCorrectRatio = Label(self.ParentsReport,text= "Their overall percentage: " + str(FirstPercentage)+"%",font=["Arial",18],bg="white")
        lblOWrong = Label(self.ParentsReport,text=str(ChildsName) + " has got these type of questions wrong as follows: ",font=["Arial",15],bg="white") 
